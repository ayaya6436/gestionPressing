...
define('URL','http://localhost/pressClean');
?>
...
<meta content="" name="descriptison">
  ...
  <link type="text/css" rel="stylesheet" href="<?= URL;?>/assets/css/jquery-te-1.4.0.css">
  ...
  <script src="<?= URL;?>/assets/vendor/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
    ...
    <script type="text/javascript" src="<?= URL;?>/assets/font-awesome/js/all.min.js"></script>
  <script type="text/javascript" src="<?= URL;?>/assets/js/jquery-te-1.4.0.min.js" charset="utf-8"></script>
